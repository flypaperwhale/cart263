...
function draw() {
  ...
  if (state === `Game`) {
    ...
    if (backgroundColor === `green`) {
      // animals shuffle when background is green
      for (let i = 0; i < animals.length; i++) {
        animals[i].update();
      } // display animals shuffling
      for (let i = 0; i < leftists.length; i++) {
    ...
    for (let i = 0; i < leftists.length; i++) {
      // look through the leftists array
      if (leftists[i].foundCounter === true) {
        // if a leftist has been found
    ...
    if (leftistsFound === 3) {
      // if the three leftists are found
...
function changeBGtoYellow() {
  // change background color from green to yellow
  if (backgroundColor === `green`) {
...
function shuffleAnimals() {
  // changes ALL animal positions
  for (let i = 0; i < animals.length; i++) {
    animals[i].changePosition(); // change animal positions during shuffle
  }
  for (let i = 0; i < leftists.length; i++) {
    if (leftists[i].found) {
      // if the leftist is found and spinning
      // do nothing
    } else {
      // otherwise change leftist position during shuffle
